...
<c:forEach items="${listaOradores}" var="orador">
       <tr>
            ...
            <td>${orador.fechaDeAlta}</td>
            <td>
                <a href="${pageContext.request.contextPath}/ver_oradores?accion=actualizar&id=${orador.id}" class="btn btn-warning" type="button">
            ...
            <td>
                <a href="${pageContext.request.contextPath}/ver_oradores?accion=borrar&id=${orador.id}" class="btn btn-danger" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" fill="currentColor"
